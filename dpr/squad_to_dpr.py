        ...
        for paragraph in article["paragraphs"]:
            ...
            for question in paragraph["qas"]:
                ...
                hard_negative_ctxs = get_hard_negative_contexts(retriever=retriever,
                                                                question=question["question"], # context가 아니네??? question["question"]
                                                                answers=answers,
...
def main(squad_input_filename: Path,
    ...
    document_store = ElasticsearchDocumentStore(host="localhost", username="", password="", index="document", custom_mapping=custom_mapping)
    # 3. Load data into the document store  # write_document
...
if __name__ == '__main__':
    ...
    preprocessor = PreProcessor(split_length=300,
                                split_overlap=0,
