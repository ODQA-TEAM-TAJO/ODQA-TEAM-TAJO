...
def postprocess_qa_predictions(
    ...
    need_socore_correction: bool = False,
):
    """
                    ...
                    prelim_predictions.append(
                        {
                            ...
                            "score": start_logits[start_index] + end_logits[end_index] if not need_socore_correction else start_logits[start_index] + 0.1*end_logits[end_index] - 0.5*i,
